...
/* harmony import */ var _modules_dynamic_adaptive__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/dynamic-adaptive */ "./src/js/modules/dynamic-adaptive.js");
/* harmony import */ var _modules_burger_header__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/burger-header */ "./src/js/modules/burger-header.js");
/* harmony import */ var _modules_main_menu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/main-menu */ "./src/js/modules/main-menu.js");
/* harmony import */ var _modules_main_sliders__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/main-sliders */ "./src/js/modules/main-sliders.js");
/* harmony import */ var _modules_swiper_build__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/swiper-build */ "./src/js/modules/swiper-build.js");
/* harmony import */ var _modules_filters_catalog__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/filters-catalog */ "./src/js/modules/filters-catalog.js");
/* harmony import */ var _modules_functions__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/functions */ "./src/js/modules/functions.js");
// Импорт js модулей
...
Object(_modules_dynamic_adaptive__WEBPACK_IMPORTED_MODULE_1__["default"])();
Object(_modules_burger_header__WEBPACK_IMPORTED_MODULE_2__["default"])();
Object(_modules_main_menu__WEBPACK_IMPORTED_MODULE_3__["default"])();
Object(_modules_main_sliders__WEBPACK_IMPORTED_MODULE_4__["default"])();
Object(_modules_swiper_build__WEBPACK_IMPORTED_MODULE_5__["default"])();
Object(_modules_filters_catalog__WEBPACK_IMPORTED_MODULE_6__["default"])();
Object(_modules_functions__WEBPACK_IMPORTED_MODULE_7__["default"])();

/***/ }),

/***/ "./src/js/lib/nouislider.js":
/*!**********************************!*\
  !*** ./src/js/lib/nouislider.js ***!
  \**********************************/
...
/***/ "./src/js/modules/burger-header.js":
/*!*****************************************!*\
  !*** ./src/js/modules/burger-header.js ***!
  \*****************************************/
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  burger.onclick = function () {
    ...
    burger.nextElementSibling.classList.toggle('_active'); // let arr = [...burger.children]
    // arr.forEach(i => {
...
/***/ "./src/js/modules/filters-catalog.js":
/*!*******************************************!*\
  !*** ./src/js/modules/filters-catalog.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _lib_nouislider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../lib/nouislider */ "./src/js/lib/nouislider.js");
/* harmony import */ var _lib_nouislider__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_lib_nouislider__WEBPACK_IMPORTED_MODULE_0__);

/* harmony default export */ __webpack_exports__["default"] = (function () {
  var priceSlider = document.querySelector('.price-filter__slider');
  if (!priceSlider) return;
  _lib_nouislider__WEBPACK_IMPORTED_MODULE_0___default.a.create(priceSlider, {
    start: [0, 100000],
    connect: true,
    tooltips: true,
    format: {
  ...
  var filterItems = document.querySelectorAll('._spoller');
    ...
    filterItems.forEach(function (item) {
      item.addEventListener('click', function () {
        if (!item.classList.contains('_active')) {
          ...
          item.nextElementSibling.classList.add('_slide');
          item.nextElementSibling.style.maxHeight = "".concat(item.nextElementSibling.scrollHeight, "px");
          filterTitle.nextElementSibling.style.maxHeight = "".concat(filterTitle.nextElementSibling.scrollHeight + item.nextElementSibling.scrollHeight, "px");
        } else {
          item.classList.remove('_active');
          item.nextElementSibling.classList.remove('_slide');
  ...
  filterToggle(); //----------- Скрыть фильтр товаров
  ...
  window.addEventListener('load', function () {
    filterTitle.nextElementSibling.style.maxHeight = "".concat(filterTitle.nextElementSibling.scrollHeight, "px");

    if (isMobile()) {
      filterTitle.nextElementSibling.classList.remove('_ac');
      filterTitle.nextElementSibling.style.maxHeight = 0;
      filterTitle.nextElementSibling.style.overflow = 'hidden';
    }

    filterTitle.addEventListener('click', function () {
      if (!filterTitle.nextElementSibling.classList.contains('_ac')) {
        filterTitle.nextElementSibling.classList.add('_ac');
        filterTitle.nextElementSibling.style.maxHeight = "".concat(filterTitle.nextElementSibling.scrollHeight, "px");
      } else {
        filterTitle.nextElementSibling.classList.remove('_ac');
        filterTitle.nextElementSibling.style.maxHeight = 0;
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  // let isMobile = { Android: function () { return navigator.userAgent.match(/Android/i) }, BlackBerry: function () { return navigator.userAgent.match(/BlackBerry/i)}}
  // if (isMobile) {
  //   document.querySelector('body').classList.add('_touch')
  // }
  var quantityBtns = document.querySelectorAll('.quantity__button');
  var inp = document.querySelector(".quantity__input input");
  if (!quantityBtns || !inp) return;
  inp.addEventListener('input', restrictToInteger);
  ...
  function quantity() {
    if (quantityBtns.length > 0) {
      var _loop = function _loop(index) {
        var quantityBtn = quantityBtns[index];
        quantityBtn.addEventListener('click', function () {
          var value = parseInt(quantityBtn.closest('.quantity').querySelector('input').value);

          if (quantityBtn.closest('.quantity').querySelector('input').value === 'NaN') {
            value = 1;
          } else if (quantityBtn.classList.contains('quantity__button_plus')) {
            value++;
          } else {
            value = value - 1;
      ...
      for (var index = 0; index < quantityBtns.length; index++) {
        _loop(index);
      }
    }
  }
  ...
  var tabsBtn = document.querySelectorAll('._tabs-item');
  var tabsContent = document.querySelectorAll('._tabs-block');

  function tabs() {
    tabsBtn.forEach(function (i, elem) {
      i.addEventListener('click', function () {
        if (!i.classList.contains('_active')) {
          tabsBtn.forEach(function (i, elem) {
            i.classList.remove('_active');
            tabsContent[elem].classList.remove('_active');
          });
          i.classList.add('_active');
          tabsContent[elem].classList.add('_active');
        }
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  var menu = document.querySelectorAll('.menu-page__link_parent');
  if (!menu) return;
  var menuItems = document.querySelectorAll('.submenu-page__item');
  /* Навигация меню
  */

  menu.forEach(function (i) {
    i.addEventListener('click', function (e) {
      var submenu = i.getAttribute('data-item');
      e.preventDefault();

      if (menuItems[submenu].classList.contains('_active')) {
        menuItems[submenu].classList.remove('_active');
        i.classList.remove('_active');
        return;
      }
      ...
      i.classList.add('_active');
      menuItems[submenu].classList.add('_active');
    });
  });
  var burger = document.querySelector('.menu-page__burger');
  var body = document.querySelector('.menu-page__body');
  var bodyCont = document.querySelector('.menu-page__submenu');
  burger.addEventListener('click', function () {
    ...
    if (!burger.classList.contains('_active')) {
      ...
      bodyCont.style.maxHeight = "100%";
      bodyCont.classList.add('_active');
    } else {
      burger.classList.remove('_active');
      body.style.maxHeight = null;
      bodyCont.style.maxHeight = null;
      bodyCont.classList.remove('_active');
    }
  });
  /* Поиск по категориям
  */

  var search = document.querySelector('.search-page__title');
  var searchItemsWrap = document.querySelector('.categories-search');
  search.addEventListener('click', function (e) {
    if (!search.classList.contains('_active')) {
      searchItemsWrap.style.maxHeight = "".concat(searchItemsWrap.scrollHeight, "px");
      search.classList.add('_active');
    } else {
      searchItemsWrap.style.maxHeight = null;
      search.classList.remove('_active');
    }
  });
  var searchСategories = document.querySelectorAll('.categories-search__checkbox .checkbox__input');
  var searchTitle = document.querySelector('.search-page__span');
  var searchCount = 0;

  function getCountCategory() {
    var _iterator = _createForOfIteratorHelper(searchСategories),
        _step;
    ...
    try {
      var _loop = function _loop() {
        ...
        input.addEventListener('click', function (e) {
          input.checked === true ? searchCount++ : searchCount--;

          if (searchCount < 1) {
            searchTitle.textContent = "\u0412\u0435\u0437\u0434\u0435";
          } else {
            searchTitle.textContent = "".concat(searchTitle.dataset.text).concat(searchCount);
          }
        });
      };
...
/***/ "./src/js/modules/main-sliders.js":
/*!****************************************!*\
  !*** ./src/js/modules/main-sliders.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (function () {// function ibg() {
...
/***/ "./src/js/modules/swiper-build.js":
/*!****************************************!*\
  !*** ./src/js/modules/swiper-build.js ***!
  \****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _lib_swiper_min__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../lib/swiper.min */ "./src/js/lib/swiper.min.js");
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  //       slider_wrapper.classList.add('swiper-wraper')
  ...
  // })
  function mainslider() {
    return new _lib_swiper_min__WEBPACK_IMPORTED_MODULE_0___default.a('.mainslider__body', {
      // loop: true,
      observer: true,
      observerParents: true,
      sliderPerView: 1,
  ...
  if (document.querySelector('.mainslider')) {
    ...
    var mainsliderDotts = document.querySelectorAll('.mainslider__dotts .swiper-pagination-bullet');
    mainsliderImages.forEach(function (elem, i) {
      var mainsliderImage = elem.querySelector('img').getAttribute('src');
      mainsliderDotts[i].style.backgroundImage = "url(\"".concat(mainsliderImage, "\")");
    });
  }
}); //--- Слайдер товаров

function productsSlider() {
  return new _lib_swiper_min__WEBPACK_IMPORTED_MODULE_0___default.a('.products-slider__item', {
    // loop: true,
    observer: true,
    observerParents: true,
    slidesPerView: 1,
...
function brandsSlider() {
  return new _lib_swiper_min__WEBPACK_IMPORTED_MODULE_0___default.a('.brands-slider__body', {
    loop: true,
    observer: true,
    observerParents: true,
    slidesPerView: 5,
...
function productImgSlider() {
  return new _lib_swiper_min__WEBPACK_IMPORTED_MODULE_0___default.a('.images-product__mainslider', {
    // loop: true,
    observer: true,
    observerParents: true,
    slidesPerView: 1,
...
function productImgSubslider() {
  return new _lib_swiper_min__WEBPACK_IMPORTED_MODULE_0___default.a('.images-product__subslider', {
    // loop: true,
    observer: true,
    observerParents: true,
    slidesPerView: 4,
